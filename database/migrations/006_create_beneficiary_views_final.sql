-- Migration: Create beneficiary and analytics views with proper column names
-- Date: 2025-01-06
-- Description: Creates views for CAIXA BI team KPIs with correct uppercase column names
...
-- 3. Social Work View (check column names in trabalho_social)
...
-- 6. Program Summary View (now with consistent data types)
